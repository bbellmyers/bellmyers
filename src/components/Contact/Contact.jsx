...
class Contact extends Component {
            ...
            <table border="0" cellPadding="0" cellSpacing="0">
              <tbody>
                ...
                <tr>
                  <td>Street:</td>
                  <td>
                    <input type="text" name="street1" size="30" />
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td>&nbsp;</td>
                  <td>
                    <input type="checkbox" name="sendBWsamples" value="send" /> Black &amp; White
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>
                    <input type="checkbox" name="sendColorSamples" value="send" /> Color
                  </td>
                </tr>
                <tr>
                  <td>&nbsp;</td>
                  <td>
                    Style: <input type="text" name="sendStyle" size="25" />
                  </td>
                </tr>
                <tr>
                  <td colSpan="2">&nbsp;</td>
                ...
                <tr>
                  <td colSpan="2">
                    <input
                      ...
                      name="Send"
                      onClick={e => {
                        return this.validateContactForm(document.frmContact, e);
                      }}
                    />
                  </td>
                </tr>
  ...
  validateContactForm(frm, e) {
    if (this.isBlank(frm.realname) || this.isBlank(frm.email) || this.isBlank(frm.comments)) {
      alert('Sorry!  A required field missing. Please fill in\nall the fields with a red asterisk.');
      e.preventDefault();
    }
    if (
      frm.mailinglist.checked &&
